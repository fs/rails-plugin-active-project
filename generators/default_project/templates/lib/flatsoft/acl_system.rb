module Flatsoft
    module AclSystem
        ...
        #
        # AclSystem is a streamlined, intuitive authorisation system. It derives heavily from
        ...
        #       * error handling for helper methods (permit? bombs out with current_account == nil)
        ...
        # current account. Use SimpleAccessControl#has_permission? if you are not guarding an
        ...
        def has_permission?(rule, user = nil)
            user ||= (send(:current_account) if respond_to?(:current_account)) || nil
